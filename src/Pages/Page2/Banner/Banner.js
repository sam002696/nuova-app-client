    ...
    return (
        <>
            ...
            <div className="relative">
                ...
                <img className='absolute -z-20 -top-44' src={p2_b1_img7} alt="" />
                {/* We've used 3xl here, but feel free to try other max-widths based on your needs */}
                <div className="max-w-5xl mx-auto">

                    {/* Content goes here */}
                    <div className='grid grid-cols-4 gap-x-5' >
                        <div className='space-y-5 py-10 col-span-2 mt-12 relative z-10'>
                            ...
                            <p className='text-[#DEE1E5] font-normal text-lg'>
                                From renting a home in just a few clicks to simple and effective property management, Nuova will always make sure you are looked after.
                            </p>
                            <div className=''>
            ...
            <div className="">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    {/* Content goes here */}
                    <div className='pt-24'>
                        <h1 className='text-4xl font-mono font-semibold text-center'>Renting made easy with Nuova</h1>
            ...
            <div className=" px-4 sm:px-6 lg:px-8 pb-20 ">
                ...
                <div className=" space-y-8 mt-12">
                  ...
                  We understand the difficulties that can occur when it comes to renting, we have had bad experiences ourselves, too many agencies treat tenants like an inconvenience and we are here to change that. From renting a home in just a few clicks to simple and effective property management, Nuova will always make sure you are looked after.
                </p>
                </div>
                </div>
                <div className="max-w-5xl mx-auto">
                        ...
                        <div className='space-y-8 py-4 col-span-1 mt-20'>
                            ...
                            <div className='grid grid-cols-4 gap-x-5 p-5 bg-slate-100 shadow-lg' >
                                ...
                                <div className='space-y-4 col-span-3'>
                                    ...
                                    Have an instant overview of your Nuova home, always be kept up to date.
                                    </p>
                                </div>
                            ...
                            <div className='grid grid-cols-4 gap-x-5 p-5 bg-slate-50 shadow-md' >
                                ...
                                <div className='space-y-4 col-span-3'>
                                    ...
                                    At the touch of a button report any issues through the Nuova tenant App, speak directly to your dedicated property manager, all in App!
                                    </p>
                                </div>
                            ...
                            <div className='grid grid-cols-4 gap-x-5 p-5 bg-slate-50 shadow-md' >
                                ...
                                <div className='space-y-4 col-span-3'>
                                    ...
                                    <p className='text-[#565151] font-normal text-sm text-justify'>
                                    Tenants can make payments from any device, anywhere, they can also set up re occuring payments to make sure they never make a late payment.
                                    </p>
                                </div>
            ...
            <div className=" px-4 sm:px-6 lg:px-8 pb-20 ">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='grid grid-cols-2 gap-x-12' >
                        ...
                        <div className='col-span-1 relative -right-24'>


                            <div className='absolute'>
                                <img className='mt-24' src={p2_b3_img2} alt="" />
                            </div>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='grid grid-cols-2 gap-x-12' >
                        ...
                        <div className='col-span-1  '>
                            <img className='mb-6 mt-16 relative z-20' src={p2_b4_img0} alt="" />
                            
                        </div>

                        <div className='space-y-8 col-span-1 mt-28 relative left-20'>
                            <div className='text-[#162A43] banner-text font-medium font-sans '>
                                Repairs without having to call
                            </div>
                            <p className='text-[#565151] font-normal text-lg'>
                                No more waiting for a call back, simply raise a maintenance request through the web dashboard and a member of our team will assist you right away! Use the Nuova web app to report any maintenance issues. Take a photo, write a description and your property manager will take care of the rest.
                            </p>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='grid grid-cols-2 gap-x-12' >
                        ...
                        <div className='space-y-8 py-10 col-span-1 mt-28'>
                            ...
                            <p className='text-[#565151] font-normal text-lg'>
                                From the single lick of a button you will have a complete oversight of your Nuova home. You can report repairs, speak to a member of our team and receive real time updates!
                            </p>
                        ...
                        <div className='col-span-1 relative -right-36'>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='space-y-3 text-center p-8'>
                        ...
                        <p className='text-[#565151] font-normal text-lg font-sans w-4/5 mx-auto'>
                            We're here to help you find the perfect rental property. Whether it's a cozy apartment or a spacious house, our dedicated team is ready to assist you. Contact us today to start your journey toward your dream space!
                        </p>

                    </div>

                    <div className="py-5 px-6 sm:px-10 lg:col-span-2 xl:p-12 max-w-3xl mx-auto">
