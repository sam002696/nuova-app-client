...
const Banner = () => {
    ...
    const people = [
        { no: '1', service: 'Listing Creation', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '2', service: 'Pricing Optimisation', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '3', service: 'Cleaning + Laundry & Linen', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '4', service: 'Guest Screening', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '5', service: 'Full Communication', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '6', service: '24 Hour Check-ins', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '7', service: 'Stocking up Consumables', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '8', service: '24 Hour Maintenance Support', management: p4_TI_img1, individually: p4_TI_img2 },
        { no: '9', service: 'Guest Experience', management: p4_TI_img1, individually: p4_TI_img2 },
        // More people...
    ]
        ...
        <>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='space-y-6 text-center p-20'>
                        <div className='text-[#162A43] font-semibold text-5xl font-sans'>
                            <h1 className='leading-snug'>To put it simply we take the <br /> hassle out of hosting</h1>
                        </div>

                        <p className='text-[#565151] font-normal text-lg font-sans'>
                            We are dedicated to helping property owners maximise their short-term property rental opportunities via Airbnb and other leading booking sites. We take care of every single detail 365 days a year so you don’t have to, handling your property’s set up and online profile, photography, bookings and price optimisation to achieve maximum revenue.
                        </p>
            ...
            <div className="relative bg-[#F7F1E9] pt-16 pb-20 px-4 sm:px-6 lg:pt-4 lg:pb-28 lg:px-8">
                ...
                <div className="relative max-w-5xl mx-auto">
                    <div className="text-center">
                        <h2 className="text-3xl text-[#162A43] font-bold sm:text-3xl font-sans">We have got you covered</h2>
                    </div>
                    <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-4 lg:max-w-none">
                        {posts.map((post) => (
                            <div key={post.title} className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                                <div className="flex-shrink-0 bg-white">
                                    <img className="h-48 w-full p-3 object-cover" src={post.imageUrl} alt="" />
                                </div>
                                ...
                                <table className="min-w-full border-separate" style={{ borderSpacing: 0 }}>
                                    ...
                                    <tbody className="bg-white">
                                        {people.map((person, personIdx) => (
                                            <tr key={person.email} className={personIdx % 2 === 0 ? "bg-white" : "bg-[#F5F5F5]"}>
                                                <td
            ...
            <div className=" px-4 sm:px-6 lg:px-8 pb-20 ">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    {/* Content goes here */}
                    <div className='pt-16'>
                        <h1 className='text-4xl font-mono font-semibold text-center'>Easy Steps</h1>
                        ...
                        <div className='space-y-3 py-10 col-span-1 mt-8'>
                            ...
                            <div className='relative'>
                                ...
                                <div className='absolute z-20 top-10 left-20'>
                                    <img className='mb-6 w-2/3 mx-auto' src={p4_b7_V1_img1} alt="" />
                                </div>
                            </div>
                        ...
                        <div className='space-y-3 py-10 col-span-1 mt-8'>
                            ...
                            <div className='relative'>
                                ...
                                <div className='absolute z-20 top-12 left-28'>
                                    <img className='mb-6 w-2/3 mx-auto' src={p4_b7_V2_img2} alt="" />
                                </div>
                            </div>
                        ...
                        <div className='space-y-3 py-10 col-span-1 mt-8'>
                            ...
                            <div className='relative'>
                                ...
                                <div className='absolute z-20 top-12 left-24'>
                                    <img className='mb-6 w-2/3 mx-auto' src={p4_b7_V3_img3} alt="" />
                                </div>
                            </div>
