  ...
  return (
    <div className="relative bg-gray-50 pt-8 pb-20 px-4 sm:px-6 lg:pt-8 lg:pb-8 lg:px-8">
      <div className="relative max-w-9xl mx-auto">
        ...
        <div className="mt-12 max-w-lg mx-auto grid gap-8 lg:grid-cols-2 2xl:grid-cols-3 lg:max-w-7xl">
          {allProperties.map((property) => (
            ...
            >
              ...
              <div className="grid grid-cols-3 bg-gray-100 group hover:bg-slate-600 pt-5 pb-5 pl-6  gap-x-8 pr-2">
