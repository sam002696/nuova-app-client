...
const user = {
  ...
  email: "eli.olsen@example.com",
  role: "Tenant of Property #4, Unit #14B",
  imageUrl:
    "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
};
const stats = [
  { label: "Next Rent Amount", value: "$2100" },
  { label: "Due Date", value: "01-12-2022" },
  { label: "Property / Unit", value: "16182 RIO BAILEY / A2" },
];
const actions = [
  {
    icon: ClockIcon,
                      ...
                      <div className="mt-8">
                        <h3 className="text-lg font-medium">
                          <a href={action.href} className="focus:outline-none">
                            ...
                            />
                            {action.name}
                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-md font-medium bg-blue-100 text-blue-800 ml-2">
                              {/* <svg
