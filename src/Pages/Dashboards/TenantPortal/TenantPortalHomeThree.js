    ...
    return (
        <>
            <div className="bg-gray-100">
                ...
                <div className="mx-auto bg-gray-100 grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8  px-4 sm:px-6  lg:max-w-7xl lg:grid-cols-3 lg:px-8">
                        ...
                        <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-1">
                            <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                <div className="flex-shrink-0">
                                    <img className="h-64 w-full object-cover" src='https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80' alt="" />
                                </div>
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 block">
                                            <p className="text-lg font-semibold tracking-wider text-gray-700">St. James Park 921b, <br /> London W1T tRJ, England</p>
                            ...
                            <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                ...
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 block">
                                            <p className="flex items-center text-2xl font-semibold font-mono text-green-600"> <CurrencyPoundIcon className="h-6 w-6 text-green-600 rounded-lg"
                                                aria-hidden="true" />1,699  </p>
                                            ...
                                            <div className='flex flex-row justify-between mt-8'>
                                                <p className=" flex items-center text-md font-medium text-gray-600">
                                                    <CalendarIcon className="h-6 w-6 text-green-400 rounded-lg"
                                                        aria-hidden="true" /> <span className='mx-2'>01 June, 2022</span>
                                                </p>
                                                <p className=" flex items-center text-md font-medium text-cyan-600">
                                                    <ArrowRightIcon className="h-4 w-6 text-gray-700 rounded-lg"
                            ...
                            <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                ...
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 block">
                                            <p className="flex items-center text-2xl font-semibold font-mono text-sky-600"> <CurrencyPoundIcon className="h-6 w-6 text-sky-700 rounded-lg"
                                                aria-hidden="true" />1,200  </p>
                                            <p className="text-sm font-medium text-gray-400">
