        ...
        <div className="bg-white">
          <main>
            ...
            <div className="relative mb-2">
              ...
              <div className="mx-auto max-w-9xl sm:px-0 lg:px-0">
                <div className="relative shadow-xl sm:overflow-hidden">
                  ...
                  <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                    ...
                    <p className="mx-auto mt-6 max-w-lg text-center text-xl text-cyan-200 sm:max-w-3xl">
                      Make it easier than ever to manage every aspect of tenant
                      relations, from ledgers to leases, and stay on top of all
                      important updates with an easy-to-use tenant portal.
                    </p>
        ...
        <div className="relative bg-white py-8 sm:py-24 lg:py-8">
          <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
              ...
              prospective, active, and old tenants. If it's a new prospective
              tenant, you can send an online rental application and run
              background checks.
            </p>
            <div className="mt-12">
