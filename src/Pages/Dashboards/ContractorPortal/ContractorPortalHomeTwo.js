            ...
            <div className=" bg-gradient-to-l from-stone-100 to-white">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8  px-4 sm:px-6  lg:max-w-7xl lg:grid-cols-3 lg:px-8">
                    <div className="relative pt-4 pb-20 lg:pt-4 lg:pb-28">
                                                    ...
                                                    >
                                                        <div className="flex flex-1 flex-col p-8">
                                                            ...
                                                            <div className=" flex flex-row  space-x-2 items-center mt-4">
                                                                ...
                                                                <p className=" text-sm text-gray-500">{person.Street} , {person.City} , {person.Zip} , {person.Country}</p>
                                                            </div>
                                                        </div>
                        ...
                        <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-1">
                            <h2 className="text-2xl font-semibold text-gray-700 leading-2 tracking-wide">Getting the Most of Nuova Contractor App</h2>
                        </div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-2 mb-4 block">
                                            <p className="text-sm text-gray-500">
                                                Learn which companies walk the walk when it comes to diversity and inclusion.
                                            </p>
                    ...
                    <div className="col-span-2 relative pt-4 pb-20  lg:pt-4 lg:pb-28">
                                    ...
                                    <div className="flex flex-wrap items-center justify-between">
                                        <div className="flex w-0 flex-1 items-center">
                                            ...
                                            <p className="ml-3 truncate font-medium text-white">
                                                ...
                                                <span className="hidden md:inline">Big news! We're excited to announce 20+ new jobs.</span>
                                            </p>
                                        </div>
                        ...
                        <div className="mx-auto mt-12 grid max-w-lg gap-2 lg:max-w-none lg:grid-cols-1">
                            <h2 className="text-3xl font-bold text-gray-700 leading-2 tracking-wide">Explore Jobs Near You</h2>
                            <p className="text-lg text-gray-500 leading-2 tracking-wide">Recommendations are based on your profile, job preferences, and activity on Nuova Portal.</p>
                        </div>
                        ...
                        <div className="mx-auto mt-12 grid max-w-lg gap-2 lg:max-w-none lg:grid-cols-1">
                                    ...
                                    >
                                        <div className="w-full flex justify-between px-6 py-6 space-x-6">
                                            ...
                                            <div className="flex-1 truncate">
                                                ...
                                                <p className="mt-1 text-gray-500 text-sm truncate">
                                                    $10.50 - $14.00 Per Hour <br /> (Employer est.)
                                                </p>
                                            </div>

                                            <div className='flex flex-col justify-between'>
                                                <button className='mt-2 flex-shrink-0 inline-block px-2 py-1.5 bg-green-500 text-xs font-medium text-white border-green-700 rounded-lg'>Apply</button>
                                                <div className="">

                                                    <p className="mt-1 text-gray-500 text-sm truncate text-right">1d</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <p className='text-center mt-2 text-md text-blue-700'>See All Jobs ...</p>
                        </div>
                            ...
                            <div className="bg-white">
                                <div className="mx-auto max-w-7xl py-8 px-4 sm:px-6 lg:py-8 lg:px-8">
                                    ...
                                    <p className="inline text-md font-medium tracking-tight text-green-500 sm:block sm:text-md">
                                        Get jobs matching your preferences as soon as they're posted.
                                    </p>
