...
const features = [
    ...
    { name: 'Responsibilities', description: 'Develop/modify a boiler hardware for testing interactions between physical products and software' },
    { name: 'Location', description: 'Flat No-13B, Holger Street, London' },
    { name: 'Required Experience', description: 'Hand sanded and finished with natural oil' },
    { name: 'Timeline', description: 'Prefer Weekends' },
    { name: 'About Nuova', description: 'Tech enabled, which enables our operating to be much more efficient and handle tasks almost instantly. Certified contractors, all of the contractors we use will have to be vetted prior to being able to work with us.' },
]
            ...
            <div className="bg-white">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-12 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <ul className="space-y-7">
                            <div className="mx-auto max-w-2xl lg:max-w-none mb-4">
                                <h2 id="testimonial-heading" className="text-2xl font-semibold text-cyan-700 inline-flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12" />
                                    </svg>
                                    <span className='mx-3'>Most Relevent Jobs </span> </h2>
                            </div>
                            {reports.map((report) => (
                                <li
                                    key={report.email}
                                ...
                                >
                                    <div className="w-full flex justify-between px-6 py-6 space-x-6">
                                        ...
                                        <div className='flex flex-col justify-between'>
                                            <button className='mt-2 flex-shrink-0 inline-block px-3 py-2 bg-white text-xs font-medium text-gray-700 border-2 border-gray-700 rounded-lg'>Details</button>
                                            <div className="flex items-center space-x-2">
                                                <p className="mt-1 text-gray-500 text-sm truncate">
                                                    Easy Apply
                                                </p>
                                                <p className="mt-1 text-gray-500 text-sm truncate">1d</p>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div className='p-8 pt-12 border-2 border-gray-200 rounded-md bg-white shadow-md shadow-gray-200'>
                        ...
                        <h2 className="text-xl font-semibold tracking-tight text-gray-900 sm:text-xl mt-8">Task Summary : </h2>
