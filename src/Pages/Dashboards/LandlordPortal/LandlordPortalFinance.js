          ...
          <div className="mx-auto max-w-5xl py-4 sm:py-4 lg:py-4">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                PayProp allows you to have a complete oversight of your
                properties in one place, to compare rents and costs, quickly and
                easily.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                With the PayProp Owner App landlords can see if the rent has
                been paid, income on their portfolio, third-party payment status
                and much more.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
...
export default LandlordPortalFinance;
